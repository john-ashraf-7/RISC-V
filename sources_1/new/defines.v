...
`define     ALU_LUI         5'b010_11 //Added to support LUI
`define     ALU_AUIPC       5'b111_11 //Added to support AUIPC
`define     ALU_OR          5'b001_00
`define     ALU_AND         5'b001_01
`define     ALU_XOR         5'b001_11

//added to support mul, div instructions
`define     ALU_MUL         5'b100_10
`define     ALU_MULH        5'b100_00
`define     ALU_MULHSU      5'b100_01
